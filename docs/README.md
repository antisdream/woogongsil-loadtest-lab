...
우공실 성능 테스트는 서비스 코드 저장소와 분리해 관리합니다. 이 문서는 회차별 테스트 기록을 찾기 위한 인덱스입니다.
...
- 원문을 그대로 복제하지 않고 테스트 목적, 조건, 결과, 개선 방향 중심으로 정리합니다.
- 민감 정보와 원시 로그는 저장소에 포함하지 않습니다.
- 테스트 결과는 운영 배포 판단의 보조 자료로 사용합니다.
